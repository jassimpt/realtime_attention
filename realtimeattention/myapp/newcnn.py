...
def read_dataset():
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\Hp\Downloads\archive (5)\train')
    for pos,pa in enumerate(my_list):

        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\Hp\Downloads\archivenew\train/' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\Hp\Downloads\archivenew\train/'+pa, f)
