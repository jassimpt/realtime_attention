...
data_augmentation = tf.keras.Sequential([
    RandomFlip("horizontal_and_vertical"),   # Random Flip
    RandomRotation(0.2),                     # Rotate by 20%
    RandomZoom(0.2),                          # Zoom by 20%
    RandomContrast(0.1),                      # Adjust contrast
    RandomTranslation(0.1, 0.1),              # Shift images randomly
    Rescaling(1.0 / 255.0)                    # Normalize images to [0,1] range
])

# Build MobileNetV3 model
def build_mobilenetv3(input_shape=(32, 32, 3), num_classes=7):
...
dataset_path = r"C:/Users/Hp/Downloads/FER 2013"
